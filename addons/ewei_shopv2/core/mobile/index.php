...
class Index_EweiShopV2Page extends MobilePage 
{
	...
	public function getpage() 
	{
		...
		global $_GPC;
		$uniacid = $_W['uniacid'];
		$defaults = array( 'adv' => array('text' => '幻灯片', 'visible' => 1), 'search' => array('text' => '搜索栏', 'visible' => 0), 'nav' => array('text' => '导航栏', 'visible' => 1), 'notice' => array('text' => '公告栏', 'visible' => 1), 'cube' => array('text' => '魔方栏', 'visible' => 1), 'banner' => array('text' => '广告栏', 'visible' => 1), 'goods' => array('text' => '推荐栏', 'visible' => 1) );
		$sorts = ((isset($_W['shopset']['shop']['indexsort']) ? $_W['shopset']['shop']['indexsort'] : $defaults));
		//$sorts['recommand'] = array('text' => '系统推荐', 'visible' => 1);
		$sorts['tabs'] = array('text' => 'tab页面', 'visible' => 1);
		...
		//---tabs
		$category=pdo_fetchall('select * from '.tablename('ewei_shop_category').' where uniacid=:uniacid ',array(':uniacid'=>$_W['uniacid']));
