define(['core', 'tpl', 'biz/goods/picker', 'biz/member/favorite', 'biz/member/cart', 'biz/plugin/diyform', 'biz/sale/coupon/couponpicker'], function(core, tpl, picker, favorite, cart, diyform, couponpicker) {
	var modal = {};
		...
		if (modal.getComments) {
			core.json('goods/detail/get_comments', {
				...
				if (ret.status == 1 && result.list.length > 0) {
					...
					$('#comments-container .fui-cell:last-child').click(function() {
						$("#tabcomment").click()
					});
