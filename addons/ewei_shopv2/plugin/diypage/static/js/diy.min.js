define(['jquery.ui'], function (ui) {
    ...
    modal.initNavs = function () {
        modal.getNavs();
        var navgroup = {
            0: ['listmenu', 'richtext', 'title', 'line', 'blank', 'menu', 'menu2', 'picture', 'banner', 'picturew', 'pictures', 'icongroup', 'audio', 'coupon','tab_ext1',
					'tab2','sych'],
    ...
    modal.getNavs = function () {
        modal.navs = {
			...
			tab_ext1: {
                name: '扩展tab',
                params: {tab1: "tab1", tab2: "tab2", tab3: "tab3", tab4: "tab4"},
