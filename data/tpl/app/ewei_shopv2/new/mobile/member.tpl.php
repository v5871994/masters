...
<div class='fui-page  fui-page-current'>
	...
	<div class='fui-content member-page navbar'>
		...
		<div class="fui-cell-title" style="padding-bottom: 0;">我的拼团</div>
		<div class="fui-cell-group fui-cell-click">
			<a class="fui-cell" href="<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&m=feng_fightgroups&do=order&ac=order&op=list&">
				<div class="fui-cell-icon"><i class="icon icon-form"></i></div>
				<div class="fui-cell-text"><p>拼团订单</p></div>
				<div class="fui-cell-remark"></div>
			</a>
			<a class="fui-cell"  href="<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&m=feng_fightgroups&do=order&ac=mygroup&">
				<div class="fui-cell-icon"><i class="icon icon-friend"></i></div>
				<div class="fui-cell-text"><p>我的团</p></div>
				<div class="fui-cell-remark"></div>
			</a>
			<a class="fui-cell"  href="<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&m=feng_fightgroups&do=address&ac=addmanage&">
				<div class="fui-cell-icon"><i class="icon icon-address"></i></div>
				<div class="fui-cell-text"><p>我的地址</p></div>
				<div class="fui-cell-remark"></div>
			</a>
			<a class="fui-cell"  href="<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&m=feng_fightgroups&do=member&ac=coupon&">
				<div class="fui-cell-icon"><i class="icon icon-card"></i></div>
				<div class="fui-cell-text"><p>我的优惠券</p></div>
				<div class="fui-cell-remark"></div>
			</a>
			<a class="fui-cell"  href="<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&m=feng_fightgroups&do=member&ac=home&op=activity&">
				<div class="fui-cell-icon"><i class="icon icon-favor"></i></div>
				<div class="fui-cell-text"><p>活动</p></div>
				<div class="fui-cell-remark"></div>
			</a>
		</div>
		<div class="fui-cell-title" style="padding-bottom: 0;">我的商城</div>
	...
	<?php  if($hascoupon) { ?>
			<div class="fui-cell-group fui-cell-click">
				...
				<a class="fui-cell"  href="<?php  echo mobileUrl('sale/coupon/my')?>">
					<div class="fui-cell-icon"><i class="icon icon-card"></i></div>
					<div class="fui-cell-text"><p>我的优惠券</p></div>
					<div class="fui-cell-remark"><?php  if($statics['coupon']>0) { ?><span class='badge'><?php  echo $statics['coupon'];?></span><?php  } ?></div>
				</a>
			</div>
		<?php  } ?>
