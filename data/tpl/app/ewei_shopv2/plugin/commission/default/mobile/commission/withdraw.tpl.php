...
<style>
.page-commission-index .headinfo{background:#3cb4b9;border-top: 1px #3cb4b9 solid;border-bottom: 1px #3cb4b9 solid;}
...
<div class="fui-page fui-page-current page-commission-index ">
	...
	<div class='fui-according-group'>
		...
		<div class='fui-according-content'>
		    ...
		    买家确认收货（<span class='text-danger'><?php  echo $this->set['settledays']?>天</span> )后，
		    ...
		    <?php  } ?>
		    <?php  if($this->set['withdraw']>0) { ?><br/>注意：可用<?php  echo $this->set['texts']['commission']?>满 <span class='text-danger'><?php  echo $this->set['withdraw']?><?php  echo $this->set['texts']['yuan']?></span> 后才能申请<?php  echo $this->set['texts']['withdraw']?><?php  } ?>
		    </div>
		</div>
