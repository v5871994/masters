<?php defined('IN_IA') or exit('Access Denied');?><script type="text/html" id="option-picker">
	...
	<div class="fui-navbar">
		<a href="javascript:;" class="nav-item btn cartbtn" style='display:none;background:#6BC6CB'>加入购物车</a>
	    <a href="javascript:;" class="nav-item btn buybtn"  style='display:none;background:#3cb4b9' >立刻购买</a>
	    <a href="javascript:;" class="nav-item btn confirmbtn"  style='display:none;background:#3cb4b9'>确定</a>
	</div>
    </div>
    </div>
</script>