...
<style>
.page-goods-list .sort .item.on .text{color:#3cb4b9}
.fui-goods-item .detail .price .text{color:#3cb4b9}
.fui-goods-item .detail .price .buy{background:#3cb4b9 !important}
.page-goods-list .screen .btns .confirm{color:#3cb4b9}
.page-goods-list .sort .item.on .text{color:#3cb4b9}
</style>
