...
<div class="panel panel-info view2">
  ...
  <?php  if($lookinfo['id']=='') { ?>
   ...
   <?php  } ?>      
   <?php  if(is_array($friends)) { foreach($friends as $rom) { ?>
      <?php  echo $rom['name'];?>：<?php  if($lookinfo=="") { ?>****<?php  } else { ?><?php  echo $rom['val'];?><?php  } ?><br/>
   <?php  } } ?>
  </div>
 <div class="js_dialog" id="iosDialog1" style="opacity: 1; display:none;">
            ...
            <div class="weui-dialog">
                ...
                <div class="weui-dialog__bd">目前还有<?php  echo $packnum;?>次查看选手信息机会！每查看一位选手信息，消耗一次机会。</div>
...
<?php  if($reply['diamondmodel']!=1 && $reply['isshowgift']!=1) { ?>
<div class="zuanlist">
   <div class="tabtitle">
...
<div class="add" id="mytoupiao"><div class="i"><i><img src="<?php echo MODULE_URL;?>/template/static/images/xin.png"></i>投票</div></div>
</div>
...
<div class="succeed" id="succeed" style="display:none"onclick="hidemod('succeed');">
   ...
   <?php  } else { ?>
   <div class="voteadd" onclick="location='<?php  echo $reply['voteadurl'];?>'"><img src="<?php  echo $reply['voteadimg'];?>"  class="adimg" width="100%"  /><p class="adtext"><?php  echo $reply['voteadtext'];?></p></div>
   <?php  } ?>
...
var latitude=0;
var longitude=0;
<?php  if($reply['area']!="" || $reply['redpackarea']!="") { ?>
