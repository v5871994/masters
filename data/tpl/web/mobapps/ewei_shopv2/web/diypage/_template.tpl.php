<?php defined('IN_IA') or exit('Access Denied');?><!--扩展-->
<script type="text/html" id="tpl_show_tab_ext1">
    <div class="drag  " data-itemid="<%itemid%>">
        <div class="fui-tab-ext1 " style="background: <%style.background%>">
            <nav class="tab active" style="color: <%style.activecolor%>; border-color: <%style.activecolor%>;"><%params.tab1%></nav>
            <nav class="tab" style="color: <%style.textcolor%>;"><%params.tab2%></nav>
            <nav class="tab" style="color: <%style.textcolor%>;"><%params.tab3%></nav>
            <nav class="tab" style="color: <%style.textcolor%>;"><%params.tab4%></nav>
        </div>
    </div>
</script>

<!--tab2-->
<script type="text/html" id="tpl_show_tab2">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-tab2" style="margin-top: <%style.margintop%>px; background: <%style.background%>;">
            <%each data as item%>
                <%if item.text%>
                    <a class="fui-menu-item " style="font-size:<%item.fontsize%>rem;color: <%item.textcolor%>;"><%if item.iconclass%><i class="icon <%item.iconclass%>" style="color: <%item.iconcolor%>;"></i><%/if%> <%item.text%></a>
			   <%/if%>
            <%/each%>
        </div>
    </div>
...
<!--首页侧滑-->
<script type="text/html" id="tpl_show_sych">
    <div class="drag" data-itemid="<%itemid%>">
       <!--  <%if data==''%>
                            ...
                            <%if params.showprice=='1'%>
                                <div class="price">
                                    <span class="text" style="color: <%style.pricecolor%>;">
                                        ...
                                        <%if (params.showproductprice==1 && item.productprice>0 && item.productprice>item.price)||(params.showsales==1)%>
            ...
            <%if params.goodsdata>0%>
                <%each data=["c","d"] as item%>
                    <div class="fui-goods-item">
                        <div class="image" style="background-image: url('../addons/ewei_shopv2/plugin/diypage/static/images/default/goods-3.jpg');">
                                <%if (params.showicon=='1' || params.showicon=='2')%>
                                    <div class="goodsicon <%params.iconposition%>"
                                        <%if params.iconposition=='left top'%> style="top: <%style.iconpaddingtop%>px; left: <%style.iconpaddingleft%>px; text-align: left;"<%/if%>
                                        <%if params.iconposition=='right top'%> style="top: <%style.iconpaddingtop%>px; right: <%style.iconpaddingleft%>px; text-align: right;"<%/if%>
...
<script type="text/html" id="tpl_show_bindmobile">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-cell-click" style="margin-top: <%style.margintop%>px; background-color: <%style.background%>;">
            ...
            <%if params.text%>
            <div class="fui-cell-tip" style="color: <%style.textcolor%>;"><%params.text%></div>
            <%/if%>
        </div>
    </div>
</script>
...
<script type="text/html" id="tpl_show_logout">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-cell-click" style="margin-top: <%style.margintop%>px; background-color: <%style.background%>;">
            <div class="fui-cell external">
                <div class="fui-cell-text" style="text-align: center; color: <%style.textcolor%>;"><p>修改密码</p></div>
            </div>
            <div class="fui-cell external btn-logout">
                <div class="fui-cell-text" style="text-align: center; color:<%style.textcolor%>;"><p>退出登录</p></div>
            </div>
        </div>
     </div>
</script>
    ...
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-detail-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px;">
            ...
            <div class="fui-cell goods-subtitle">
                <span class="text-danger" style="color: <%style.subtitlecolor%>;">四角防摔气囊，送纳米防爆膜</span>
            </div>
            <div class="fui-cell">
...
<script type="text/html" id="tpl_show_detail_sale">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-cell-click  fui-sale-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px;">
            ...
            <%if sale.type=='yushou'%>
                <div class="fui-cell">
                    <div class="fui-cell-text" style="color: <%style.textcolor%>;"><label class="label label-default">预售</label> 预计发货时间：购买后<span class="text-danger" style="color: <%style.salecolorhigh%>;"> 7 </span>天发货</div>
                </div>
            <%/if%>
            <%if sale.type=='erci'%>
            <div class="fui-cell">
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">此商品二次购买 可享受 <span class="text-danger" style="color: <%style.salecolorhigh%>;"> 5 </span> 折优惠</div>
            </div>
            <%/if%>
            <%if sale.type=='huiyuan'%>
            <div class="fui-cell">
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">您的会员等级是<span class="text-danger" style="color: <%style.salecolorhigh%>;"> VIP </span>可享受 <span class="text-danger" style="color: <%style.salecolorhigh%>;">￥10</span> 的价格</div>
            </div>
            <%/if%>
            <%if sale.type=='youhui'%>
            <div class="fui-cell">
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">优惠 全场满 <span class="text-danger" style="color: <%style.textcolorhigh%>;">￥100</span> 包邮</div>
                <div class="fui-cell-remark"></div>
            </div>
            <%/if%>
            <%if sale.type=='jifen'%>
            <div class="fui-cell">
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">积分  购买赠送 <span class="text-danger" style="color: <%style.textcolorhigh%>;">20</span> 积分</div>
                <div class="fui-cell-remark"></div>
            </div>
            <%/if%>
            <%if sale.type=='bupeisong'%>
            <div class="fui-cell">
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">不配送区域: 天津辖区 天津辖县</div>
                <div class="fui-cell-remark"></div>
            </div>
            <%/if%>
            <%if sale.type=='biaoqian'%>
            <div class="fui-cell">
            ...
            <%if sale.type=='coupon'%>
            <div class="fui-cell">
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">领取可用优惠券</div>
            </div>
            <%/if%>
            <%if sale.type=='zengpin'%>
            <div class="fui-cell">
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">赠品: 赠品名称</div>
            </div>
            <%/if%>
            <%/each%>
        </div>
...
<script type="text/html" id="tpl_show_detail_shop">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-shop-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px;">
            ...
            <div class="fui-cell">
                <div class="fui-cell-text center" style="color: <%style.goodsnumcolor%>;">300<p style="color: <%style.goodstextcolor%>;">全部</p></div>
                <div class="fui-cell-text center" style="color: <%style.goodsnumcolor%>;">6<p style="color: <%style.goodstextcolor%>;">新品</p></div>
                <div class="fui-cell-text center" style="color: <%style.goodsnumcolor%>;">5<p style="color: <%style.goodstextcolor%>;">促销</p></div>
            </div>
            <%/if%>
            <div class="fui-cell btns">
                <div class="fui-cell-text center">
                    <a class="btn btn-default-o" style="border-color: <%style.leftnavcolor%>; color: <%style.leftnavcolor%>;"><%params.leftnavtext%></a>
                    <a class="btn btn-default-o" style="border-color: <%style.rightnavcolor%>; color: <%style.rightnavcolor%>;"><%params.rightnavtext%></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-according-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px;">
            <div class="fui-according expanded">
                ...
                <div class="fui-according-content store-container" style="height: auto;">
                    <div class="fui-list store-item">
                        ...
                        <div class="fui-list-inner store-inner">
                            ...
                            <div class="text" style="font-size: 12px; color: <%style.shopinfocolor%>;">地址: <span class="realname">山东省济南市市中区XXXXX路XXXX号</span></div>
                            <div class="text" style="font-size: 12px; color: <%style.shopinfocolor%>;">电话: <span class="address">0531-88888888</span></div>
                        </div>
                        <div class="fui-list-angle ">
                            <a><i class=" icon icon-phone" style="color: <%style.navtelcolor||'green'%>"></i></a>
                            <br>
                            <a><i class="icon icon-location" style="color: <%style.navlocationcolor||'#ff9900'%>"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="fui-list-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px;">
            <%if params.merchdata=='0'||!params.merchdata%>
                <%each data as item%>
                    <div class="fui-list">
                        <div class="fui-list-media">
                            <img src="<%item.thumb||'../addons/ewei_shopv2/static/images/merch.jpg'%>" class="round">
                        </div>
                        <div class="fui-list-inner">
                            <div class="title" style="color: <%style.titlecolor%>;"><%item.name%></div>
                            <div class="subtitle" style="color: <%style.textcolor%>;"><%item.desc%></div>
                            <div class="subtitle" style="color: <%style.rangecolor%>; font-size: 0.6rem">距离您: 1.01km</div>
                        </div>
                        <div class="fui-remark">
                            <i class="icon icon-location" style="color: <%style.locationcolor%>;"></i>
                        </div>
                    </div>
                <%/each%>
            <%else%>
                <%each data=["A","B"] as item%>
                    <div class="fui-list">
                        <div class="fui-list-media">
                            <img src="../addons/ewei_shopv2/static/images/merch.jpg" class="round">
                        </div>
                        <div class="fui-list-inner">
        ...
        <div class="diy-coupon col-<%params.couponstyle%>" style="margin: <%style.margintop%>px 0; background: <%style.background%>;">
            <%each data as item%>
                <div class="diy-coupon-item">
                    <div class="inner" style="border: 1px solid <%item.bordercolor%>; background: <%item.background%>; color: <%item.textcolor%>; margin: <%style.margintop%>px <%style.marginleft%>px;">
