	...
	<div class="col-sm-9">
	 ...
	 <form <?php if( ce('sysset.sms.temp' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <?php if( ce('sysset.sms.temp' ,$item) ) { ?>
                        <?php  if(!empty($smsset['juhe']) || (!empty($item) && $item['type']=='juhe')) { ?><label class="radio-inline"><input type="radio" class="sms-type" data-template="1" name="type" value="juhe" <?php  if($item['type']=='juhe' || empty($item)) { ?>checked<?php  } ?> <?php  if(!empty($item['type'])) { ?>disabled<?php  } ?>> 聚合数据</label><?php  } ?>
                        <?php  if(!empty($smsset['dayu']) || (!empty($item) && $item['type']=='dayu')) { ?><label class="radio-inline"><input type="radio" class="sms-type" data-template="1" name="type" value="dayu" <?php  if($item['type']=='dayu') { ?> checked<?php  } ?> <?php  if(!empty($item['type'])) { ?>disabled<?php  } ?>> 阿里大于</label><?php  } ?>
                ...
                <div class="form-group sms-template-sign" style="<?php  if($item['type']=='dayu' || $item['type']=='emay') { ?>display:block;<?php  } else { ?>display:none;<?php  } ?>">
