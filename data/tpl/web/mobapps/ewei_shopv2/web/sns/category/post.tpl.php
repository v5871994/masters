...
<div class="page-heading"> 
	<span class='pull-right'>
		...
		<?php  } ?>
		<a class="btn btn-default  btn-sm" href="<?php  echo webUrl('sns/category')?>">返回列表</a>
	</span>
	<h2><?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>版块分类 <small><?php  if(!empty($item['id'])) { ?>修改【<?php  echo $item['name'];?>】<?php  } ?></small></h2>
</div>
