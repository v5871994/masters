...
<div class='page-heading'><h2>投诉类别  <?php if(cv('sns.complain.category')) { ?><small>拖动可以排序</small><?php  } ?></h2></div>
        ...
        <table class="table  table-responsive">
            ...
            <tbody id='tbody-items'>
                ...
                <tr>
                    ...
                    <td>
                          <?php if(cv('sns.complain.category')) { ?>
                          	<a href="<?php  echo webUrl('sns/complain/catedel', array('id' => $row['id']))?>" data-toggle='ajaxRemove' class="btn btn-default btn-sm" data-confirm="确认删除此分类?"><i class="fa fa-trash"></i> 删除</a>
                          <?php  } ?>
                    </td>
