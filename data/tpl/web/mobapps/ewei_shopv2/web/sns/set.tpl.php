...
<form id="setform"  action="" method="post" class="form-horizontal form-validate">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sns.set.edit')) { ?>
            <?php echo tpl_form_field_image('data[banner]', empty($data['banner'])?'../addons/ewei_shopv2/plugin/sns/static/images/banner.png':$data['banner'])?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sns.set.edit')) { ?>
            <?php echo tpl_form_field_image('data[avatar]', empty($data['avatar'])?'../addons/ewei_shopv2/plugin/sns/static/images/head.jpg':$data['avatar'])?>
