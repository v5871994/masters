    ...
    <table class="table table-hover table-responsive">
        ...
        <td>
            ...
            <a data-toggle="ajaxModal" href="<?php  echo webUrl('sns/level/edit', array('id' => $row['id']))?>" class="btn btn-default btn-sm"
                ><i class='fa fa-edit'></i> <?php if(cv('sns.level.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?></a><?php  } ?>
            <?php  if($row['id']!='default') { ?>
            <?php if(cv('sns.level.delete')) { ?><a data-toggle='ajaxRemove' href="<?php  echo webUrl('sns/level/delete', array('id' => $row['id']))?>"class="btn btn-default btn-sm" data-confirm='确认要删除此会员等级吗?'><i class="fa fa-trash"></i> 删除</a><?php  } ?>
            <?php  } ?>
</td>
