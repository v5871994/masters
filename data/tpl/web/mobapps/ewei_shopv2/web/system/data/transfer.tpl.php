...
<div class='page-heading'><h2>数据复制转移</h2></div>
<div class='alert alert-danger'>
    ...
    <form id="dataform" action="" method="post" class="form-horizontal form-validate">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label must">源公众号</label>
                    <div class="col-sm-9">
				  ...
				  <div class="form-group">
                    <label class="col-sm-2 control-label must">目标公众号</label>
                    <div class="col-sm-9">
				...
				<div class="form-group">
                    <label class="col-sm-2 control-label">删除源公众号数据</label>
                    <div class="col-sm-9">
