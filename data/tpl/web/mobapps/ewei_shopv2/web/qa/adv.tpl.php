    ...
    <table class="table table-responsive table-hover" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php if(cv('qa.adv.edit')) { ?>
                    	<a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo webUrl('qa/adv/displayorder',array('id'=>$row['id']))?>" ><?php  echo $row['displayorder'];?></a>
                    <?php  } else { ?>
                ...
                <td>
                    ...
                    <td style="text-align:left;">
                        <?php if(cv('qa.adv.view|qa.adv.edit')) { ?>
	                        <a href="<?php  echo webUrl('qa/adv/edit', array('id' => $row['id']))?>" class="btn btn-default btn-sm">
	                        	<i class='fa fa-edit'></i> <?php if(cv('qa.adv.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>
	                        </a>
                        <?php  } ?>
                        <?php if(cv('qa.adv.delete')) { ?>
