...
<ul class="nav nav-tabs">
	...
	<li<?php  if($_GPC['do'] == 'edit') { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('edit',array('id'=>$_GPC['id'],'rid'=>$_GPC['rid']));?>"><?php  if($_GPC['id'] > 0) { ?>编辑投票用户<?php  } else { ?>添加投票用户<?php  } ?></a></li>
</ul>
<div class="clearfix">
	<form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1">
		<div class="panel panel-default" id="step1">
			...
			<?php  if($_GPC['id']!=0) { ?>
				<div class="form-group">
					...
					<div class="col-sm-8 col-xs-12">
						<input type="text" class="form-control" name="noid" value="<?php  echo $votedata['noid'];?>"/>
			...
			<?php  } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-xs-12">
						<input type="text" class="form-control" name="name" value="<?php  echo $votedata['name'];?>"/>
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8 col-xs-12">
						<input type="text" class="form-control" name="oauth_openid" value="<?php  echo $votedata['oauth_openid'];?>"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-xs-12">
						<input type="text" class="form-control" name="openid" value="<?php  echo $votedata['openid'];?>"/>
		...
		<div class="col-sm-2">
            <div class="input-group">
              <input class="form-control" type="text" value="<?php  echo $votedata['votenum'];?>"name="votenum">
		...
		<div class="col-sm-2">
            <div class="input-group">
              <input class="form-control" type="text" value="<?php  echo $votedata['giftcount'];?>"name="giftcount">
		...
		<div class="col-sm-2">
            <div class="input-group">
              <input class="form-control" type="text" value="<?php  echo $votedata['vheat'];?>"name="vheat">
          ...
          <div class="col-sm-9">
				...
				<div class="row">
				  <div class="col-xs-6 col-md-2">
					...
					<?php  if($formatdata['0']!="" && $nodownpic==1) { ?>
...
<em class="close delimage" style="position:absolute; top: 0px; right:0px;" title="删除这张图片" >×</em>
					...
					<?php  if($formatdata['1']!="" && $nodownpic==1) { ?>
				  ...
				  <div class="col-xs-6 col-md-2">
					...
					<?php  if($formatdata['2']!="" && $nodownpic==1) { ?>
	...
	<em class="close delimage" style="position:absolute; top: 0px; right:0px;" title="删除这张图片" >×</em>
					...
					<?php  if($formatdata['3']!="" && $nodownpic==1) { ?>
...
<em class="close delimage" style="position:absolute; top: 0px; right:0px;" title="删除这张图片" >×</em>
					...
					<?php  if($formatdata['4']!="" && $nodownpic==1) { ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-xs-12">
						<textarea name="introduction" class="form-control js-a" cols="30" rows="3"><?php  echo $votedata['introduction'];?></textarea>
					</div>
				</div>
		<div class="form-group">
		...
		<!--
			    <div class="form-group">
					...
					<div class="col-sm-8 col-xs-12">
						...
						<input type="radio" name="attestation" value="0" <?php  if($votedata['attestation']!=1) { ?> checked <?php  } ?> />否
					</label>
					<label class="radio-inline">
						<input type="radio" name="attestation" value="1" <?php  if($votedata['attestation']=='1') { ?> checked <?php  } ?>  />是
					</label>
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-xs-12">
						<input type="text" class="form-control" name="atmsg" value="<?php  echo $votedata['atmsg'];?>"/>
					</div>
				</div>
		-->
				<div class="form-group">
					...
					<div class="col-sm-8 col-xs-12">
						<label class="radio-inline">
						<input type="radio" name="status" value="0" <?php  if($votedata['status']=='0') { ?> checked <?php  } ?> />否
					</label>
					<label class="radio-inline">
						<input type="radio" name="status" value="1" <?php  if($votedata['status']=='1') { ?> checked <?php  } ?>  />是
					</label>
