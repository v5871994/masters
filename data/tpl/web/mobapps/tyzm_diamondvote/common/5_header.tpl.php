...
<section id="container" class="">    
    <!--header start-->
      <header class="header white-bg">
            <!--logo start-->
            <a href="<?php  echo url('accound/display');?>" class="logo" style="margin-top:0px" >
				<img src="resource/weicheng/images/login_logo.png" width="168" height="54"/>
			</a>
            <!--logo end-->            
            <div class="top-nav ">
                <!--user info start-->
 ...
 <!--<li><a href="<?php echo $_W['siteroot'].'web/index.php?c=home&a=welcome&do=ext&m=ewei_shop'?>"><i class="fa fa-umbrella"></i> 微开商城管理</a></li>-->
