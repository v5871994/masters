...
<script src="http://hkjj.v.longtick.com/tpl/Api/tyzm/common/js/mzp-packed-me.js"></script>
<div class="main">
    <ul class="nav nav-tabs">
        <li<?php  if($_GPC['do'] == 'manage' || $_GPC['do'] == '' ) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('manage');?>">活动管理</a></li>
        <li<?php  if($_GPC['do'] == 'post') { ?> class="active"<?php  } ?>><a href="<?php  echo url('platform/reply/post',array('m'=>'tyzm_diamondvote'));?>">添加活动规则</a></li>
        ...
        <table class="table table-hover">
            ...
            <tbody class="listbox">
                ...
                <tr>
                    ...
                    <td><span class="label label-primary"><?php  echo $row['jointotal'];?></span></td>
					<td><span class="label label-info"><?php  echo $row['votetotal'];?></span></td> 
					<td><span class="label label-success"><?php  echo $row['giftcount'];?>元</span></td> 
					<td><span class="label label-danger"><?php  echo $row['pvtotal'];?></span></td>
					<td><span class="label label-warning"><?php  echo $row['sharetotal'];?></span></td>
