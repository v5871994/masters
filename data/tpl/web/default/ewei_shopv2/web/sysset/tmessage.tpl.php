    ...
    <table class="table table-responsive table-hover">
        ...
        <tr><td>
            ...
            <td>
                ...
                <a class='btn btn-default  btn-sm' href="<?php  echo webUrl('sysset/tmessage/edit', array('id' => $row['id']))?>" ><i class='fa fa-edit'></i> <?php if(cv('sysset.tmessage.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?></a><?php  } ?>
                <?php if(cv('sysset.tmessage.delete')) { ?><a class='btn btn-default  btn-sm'  data-toggle='ajaxRemove' href="<?php  echo webUrl('sysset/tmessage/delete', array('id' => $row['id']))?>" data-confirm="确认删除此模板吗？" ><i class='fa fa-trash'></i> 删除</a><?php  } ?>
