							 ...
							 <?php  if(is_array($categorys)) { foreach($categorys as $category2) { ?>
							 	<?php  if($category2['parentid']==$category['id']) { ?>
								 	<div class="line">
										...
										<nav title="选择" class="btn btn-default btn-sm" data-href="<?php  if($platform=='wxapp') { ?>/pages/goods/index/index?cate=<?php  echo $category['id'];?><?php  } else { ?><?php  echo mobileUrl('goods',array('cate'=>$category2['id']), $full)?><?php  } ?>">选择</nav>
									...
									<?php  if(is_array($categorys)) { foreach($categorys as $category3) { ?>
										 <?php  if($category3['parentid']==$category2['id']) { ?>
											 <div class="line">
												...
												<nav title="选择" class="btn btn-default btn-sm" data-href="<?php  if($platform=='wxapp') { ?>/pages/goods/index/index?cate=<?php  echo $category['id'];?><?php  } else { ?><?php  echo mobileUrl('goods',array('cate'=>$category3['id']), $full)?><?php  } ?>">选择</nav>
