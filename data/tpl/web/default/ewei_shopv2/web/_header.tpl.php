...
<div class="navbar-collapse collapse" id="navbar">
	...
	<ul class="nav navbar-nav gray-bg"   style="position:fixed; left :20px; top:60px;border:1px solid #1AB394;width:114px; text-align:center;">

       <div   style="background:#1AB394;width:113px;height:30px;"><a  style="color:#fff;width:113px;padding-top:10px;line-height:30px;">应用快捷进入</a></div></br>
	  ...
	  <li  <?php  if($_W['controller']=='shop00') { ?> class="active"<?php  } ?>   style="margin-top:-15px;"     ><a   href="<?php  echo webUrl(commission)?>"><i class="fa fa-users"></i>分销设置</a></li></br>
        <?php if(cv('goods')) { ?><li <?php  if($_W['controller']=='goods00') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('diypage')?>"><i class="fa fa-cog"></i>店铺装修</a></li></br><?php  } ?>
        ...
        <?php if(cv('finance')) { ?><li <?php  if($_W['controller']=='finance00') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('taobao')?>"><i class="fa fa-github-alt"></i>商品助手</a></li></br><?php  } ?>
