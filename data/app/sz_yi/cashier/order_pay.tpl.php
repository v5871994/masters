...
require(['tpl', 'core'], function(tpl, core) {
    core.pjson('cashier/order_pay', {orderid: '<?php  echo $_GPC['orderid'];?>',openid: "<?php  echo $openid;?>"}, function (json) {
        ...
        if (result.yunpay.success) {
            $('.order_sub10').click(function () {
                ...
                core.pjson('cashier/order_pay', {
                    ...
                    location.href = core.getUrl('order/pay_yunpay', {orderid: '<?php  echo $_GPC['orderid'];?>', cashier: 1});
                    return;
                }, true, true);
             });
        }
        if (result.alipay.success) {
            $('.order_sub2').click(function () {
                ...
                core.pjson('cashier/order_pay', {
                    ...
                    location.href = core.getUrl('order/pay_alipay', {orderid: '<?php  echo $_GPC['orderid'];?>', cashier: 1});
                    return;
                }, true, true);
            });
        }
