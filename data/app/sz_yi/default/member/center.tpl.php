...
<script id="member_center" type="text/html">
 ...
 <div class="cart" style='margin-top:-20px;'>
     <a href="javascript:;"><div class="list1" style=" border-bottom:0px;border-top:0px;"><?php  if($shopset['credit']) { ?><?php  echo $shopset['credit'];?><?php  } else { ?>余额<?php  } ?>: <span style='color:#f90'><%member.credit2%></span> 
    ...
    <a href="javascript:;"><div class="list1" style="margin:-2px 0px 0; border-bottom:0px;"><?php  if($shopset['credit1']) { ?><?php  echo $shopset['credit1'];?><?php  } else { ?>积分<?php  } ?>: <%member.credit1%>

            <div class="take1" onclick="location.href='<?php  echo $this->createPluginMobileUrl('creditshop')?>'"><?php  if($shopset['credit1']) { ?><?php  echo $shopset['credit1'];?><?php  } else { ?>积分<?php  } ?>兑换</div>
