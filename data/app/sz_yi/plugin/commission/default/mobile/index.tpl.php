...
<script id='tpl_main' type='text/html'>
    ...
    <div class="top">
        <div class="top_1">
            <div class="text">
            <?php  echo $this->set['texts']['commission_total']?>：<%member.total_all%> 元<br><?php  echo $this->set['texts']['commission_ok']?>（元）</div>
    ...
    <div class="menu">  
        ...
        <!--分红-->
        <?php  if($bonus==1) { ?>
        <a href="<?php  echo $this->createPluginMobileUrl('bonus/withdraw')?>"><div class="nav nav1"><i class="fa fa-cny fa-3x" style="color:#7775FF;"></i><div class="title"><?php  echo $bonus_set['texts']['commission']?></div><div class="con"><span><?php  echo $member_bonus['commission_total'];?></span> 元</div></div></a>
        <?php  if($level) { ?>
    ...
    <?php  } ?> 
        ...
        <a href="#"><div class="nav nav1"><i class="fa fa-time fa-3x" style="color:#FF8282;"></i><div class="title">订单总计</div><div class="con"><span><%pricecount%></span> 元</div></div></a>
